  ...
  <div class="main-content">
    ...
    <div class="choose-budget">
      ...
      <div class="choose-budget-buttons">
        <button class="numberbtn" on:click={() => (budgetToDisplay = 0)}>1</button>
        <button class="numberbtn" on:click={() => (budgetToDisplay = 1)}>2</button>
        <button class="numberbtn" on:click={() => (budgetToDisplay = 2)}>3</button>
        <button class="numberbtn" on:click={() => (budgetToDisplay = 3)}>Tom</button>
      </div>
    </div>
